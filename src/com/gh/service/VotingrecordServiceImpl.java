...
public class VotingrecordServiceImpl implements VotingrecordService{
	private VotingrecordDAO votingrecordDAO;
	
	public void setVotingrecordDAO(VotingrecordDAO votingrecordDAO) {
		this.votingrecordDAO = votingrecordDAO;
	}
	
	public VotingrecordDAO getVotingrecordDAO() {
		return this.votingrecordDAO;
	}
	@Override
	public Votingrecord findById(String id) {
		// TODO Auto-generated method stub
		return votingrecordDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(Votingrecord item) {
		// TODO Auto-generated method stub
		votingrecordDAO.insert(item);
	}

	@Override
	public void update(Votingrecord item) {
		// TODO Auto-generated method stub
		votingrecordDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(Votingrecord item) {
		votingrecordDAO.updateByPrimaryKeySelective(item);
		
	}
	@Override
	public void delete(String id) {
		// TODO Auto-generated method stub
		votingrecordDAO.deleteByPrimaryKey(id);
	}
	
	@Override
	public void deleteByWhere(String swhere) {
		// TODO Auto-generated method stub  
		votingrecordDAO.deleteByWhere(swhere);
	}

	@Override
	public List<Votingrecord> execSql(String sql) {
		// TODO Auto-generated method stub
		return votingrecordDAO.execSql(sql);
	}

	@Override
	public List<Votingrecord> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		String mainSql = "SELECT * FROM votingrecord";
		...
		List<Votingrecord> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<Votingrecord> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<Votingrecord> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<Votingrecord> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from Votingrecord  where fuid  not in (select top " + min
				+ " fuid from Votingrecord "+ where + _oB + ") " + where2 + _oB; 
		List<Votingrecord> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  votingrecordDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( votingrecordDAO.selectObject(sql).toString());
	     }
	     return 0; 
