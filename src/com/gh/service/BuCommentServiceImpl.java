...
public class BuCommentServiceImpl implements BuCommentService{
	private BuCommentDAO buCommentDAO;
	
	public void setBuCommentDAO(BuCommentDAO buCommentDAO) {
		this.buCommentDAO = buCommentDAO;
	}
	
	public BuCommentDAO getBuCommentDAO() {
		return this.buCommentDAO;
	}
	@Override
	public BuComment findById(String id) {
		// TODO Auto-generated method stub
		return buCommentDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(BuComment item) {
		// TODO Auto-generated method stub
		buCommentDAO.insert(item);
	}

	@Override
	public void update(BuComment item) {
		// TODO Auto-generated method stub
		buCommentDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(BuComment item) {
		buCommentDAO.updateByPrimaryKeySelective(item);
		
	}
	@Override
	public void delete(String id) {
		// TODO Auto-generated method stub
		buCommentDAO.deleteByPrimaryKey(id);
	}
	
	@Override
	public void deleteByWhere(String swhere) {
		// TODO Auto-generated method stub  
		buCommentDAO.deleteByWhere(swhere);
	}

	@Override
	public List<BuComment> execSql(String sql) {
		// TODO Auto-generated method stub
		return buCommentDAO.execSql(sql);
	}

	@Override
	public List<BuComment> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		String mainSql = "SELECT * FROM bu_comment";
		...
		List<BuComment> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<BuComment> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<BuComment> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<BuComment> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from BuComment  where fuid  not in (select top " + min
				+ " fuid from BuComment "+ where + _oB + ") " + where2 + _oB; 
		List<BuComment> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  buCommentDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( buCommentDAO.selectObject(sql).toString());
	     }
	     return 0; 
