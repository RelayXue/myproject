...
public class BuGpsdeviceServiceImpl implements BuGpsdeviceService{
	private BuGpsdeviceDAO buGpsdeviceDAO;
	
	public void setBuGpsdeviceDAO(BuGpsdeviceDAO buGpsdeviceDAO) {
		this.buGpsdeviceDAO = buGpsdeviceDAO;
	}
	
	public BuGpsdeviceDAO getBuGpsdeviceDAO() {
		return this.buGpsdeviceDAO;
	}
	@Override
	public BuGpsdevice findById(String id) {
		// TODO Auto-generated method stub
		return buGpsdeviceDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(BuGpsdevice item) {
		// TODO Auto-generated method stub
		buGpsdeviceDAO.insert(item);
	}

	@Override
	public void update(BuGpsdevice item) {
		// TODO Auto-generated method stub
		buGpsdeviceDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(BuGpsdevice item) {
		buGpsdeviceDAO.updateByPrimaryKeySelective(item);
		
	}
	@Override
	public void delete(String id) {
		// TODO Auto-generated method stub
		buGpsdeviceDAO.deleteByPrimaryKey(id);
	}
	
	@Override
	public void deleteByWhere(String swhere) {
		// TODO Auto-generated method stub  
		buGpsdeviceDAO.deleteByWhere(swhere);
	}

	@Override
	public List<BuGpsdevice> execSql(String sql) {
		// TODO Auto-generated method stub
		return buGpsdeviceDAO.execSql(sql);
	}

	@Override
	public List<BuGpsdevice> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		String mainSql = "SELECT * FROM bu_gpsdevice";
		...
		List<BuGpsdevice> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<BuGpsdevice> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<BuGpsdevice> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<BuGpsdevice> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from BuGpsdevice  where fuid  not in (select top " + min
				+ " fuid from BuGpsdevice "+ where + _oB + ") " + where2 + _oB; 
		List<BuGpsdevice> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  buGpsdeviceDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( buGpsdeviceDAO.selectObject(sql).toString());
	     }
	     return 0; 
