...
public class BuStayRoomServiceImpl implements BuStayRoomService{
	private BuStayRoomDAO buStayRoomDAO;
	
	public void setBuStayRoomDAO(BuStayRoomDAO buStayRoomDAO) {
		this.buStayRoomDAO = buStayRoomDAO;
	}
	
	public BuStayRoomDAO getBuStayRoomDAO() {
		return this.buStayRoomDAO;
	}
	@Override
	public BuStayRoom findById(String id) {
		// TODO Auto-generated method stub
		return buStayRoomDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(BuStayRoom item) {
		// TODO Auto-generated method stub
		buStayRoomDAO.insert(item);
	}

	@Override
	public void update(BuStayRoom item) {
		// TODO Auto-generated method stub
		buStayRoomDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(BuStayRoom item) {
		buStayRoomDAO.updateByPrimaryKeySelective(item);
		
	}
	@Override
	public void delete(String id) {
		// TODO Auto-generated method stub
		buStayRoomDAO.deleteByPrimaryKey(id);
	}
	
	@Override
	public void deleteByWhere(String swhere) {
		// TODO Auto-generated method stub  
		buStayRoomDAO.deleteByWhere(swhere);
	}

	@Override
	public List<BuStayRoom> execSql(String sql) {
		// TODO Auto-generated method stub
		return buStayRoomDAO.execSql(sql);
	}

	@Override
	public List<BuStayRoom> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		String mainSql = "SELECT * FROM bu_stay_room";
		...
		List<BuStayRoom> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<BuStayRoom> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<BuStayRoom> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<BuStayRoom> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from BuStayRoom  where fuid  not in (select top " + min
				+ " fuid from BuStayRoom "+ where + _oB + ") " + where2 + _oB; 
		List<BuStayRoom> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  buStayRoomDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( buStayRoomDAO.selectObject(sql).toString());
	     }
	     return 0; 
