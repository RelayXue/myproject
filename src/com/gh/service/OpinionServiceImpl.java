...
public class OpinionServiceImpl implements OpinionService{
	...
	public Opinion findById(String id) {
		...
		return opinionDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(Opinion item) {
		// TODO Auto-generated method stub
		opinionDAO.insert(item);
	}

	@Override
	public void update(Opinion item) {
		// TODO Auto-generated method stub
		opinionDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(Opinion item) {
		opinionDAO.updateByPrimaryKeySelective(item);
	...
	public List<Opinion> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		...
		List<Opinion> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<Opinion> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<Opinion> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<Opinion> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from Opinion  where fuid  not in (select top " + min
				+ " fuid from Opinion "+ where + _oB + ") " + where2 + _oB; 
		List<Opinion> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  opinionDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( opinionDAO.selectObject(sql).toString());
	     }
	     return 0; 
