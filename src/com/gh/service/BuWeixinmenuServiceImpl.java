...
public class BuWeixinmenuServiceImpl implements BuWeixinmenuService{
	private BuWeixinmenuDAO buWeixinmenuDAO;
	
	public void setBuWeixinmenuDAO(BuWeixinmenuDAO buWeixinmenuDAO) {
		this.buWeixinmenuDAO = buWeixinmenuDAO;
	}
	
	public BuWeixinmenuDAO getBuWeixinmenuDAO() {
		return this.buWeixinmenuDAO;
	}
	@Override
	public BuWeixinmenu findById(String id) {
		// TODO Auto-generated method stub
		return buWeixinmenuDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(BuWeixinmenu item) {
		// TODO Auto-generated method stub
		buWeixinmenuDAO.insert(item);
	}

	@Override
	public void update(BuWeixinmenu item) {
		// TODO Auto-generated method stub
		buWeixinmenuDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(BuWeixinmenu item) {
		buWeixinmenuDAO.updateByPrimaryKeySelective(item);
		
	}
	@Override
	public void delete(String id) {
		// TODO Auto-generated method stub
		buWeixinmenuDAO.deleteByPrimaryKey(id);
	}
	
	@Override
	public void deleteByWhere(String swhere) {
		// TODO Auto-generated method stub  
		buWeixinmenuDAO.deleteByWhere(swhere);
	}

	@Override
	public List<BuWeixinmenu> execSql(String sql) {
		// TODO Auto-generated method stub
		return buWeixinmenuDAO.execSql(sql);
	}

	@Override
	public List<BuWeixinmenu> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		String mainSql = "SELECT * FROM bu_weixinmenu";
		...
		List<BuWeixinmenu> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<BuWeixinmenu> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<BuWeixinmenu> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<BuWeixinmenu> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from BuWeixinmenu  where fuid  not in (select top " + min
				+ " fuid from BuWeixinmenu "+ where + _oB + ") " + where2 + _oB; 
		List<BuWeixinmenu> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  buWeixinmenuDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( buWeixinmenuDAO.selectObject(sql).toString());
	     }
	     return 0; 
