...
public class GmPathLineServiceImpl implements GmPathLineService{
	private GmPathLineDAO gmPathLineDAO;
	
	public void setGmPathLineDAO(GmPathLineDAO gmPathLineDAO) {
		this.gmPathLineDAO = gmPathLineDAO;
	}
	
	public GmPathLineDAO getGmPathLineDAO() {
		return this.gmPathLineDAO;
	}
	@Override
	public GmPathLine findById(String id) {
		// TODO Auto-generated method stub
		return gmPathLineDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(GmPathLine item) {
		// TODO Auto-generated method stub
		gmPathLineDAO.insert(item);
	}

	@Override
	public void update(GmPathLine item) {
		// TODO Auto-generated method stub
		gmPathLineDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(GmPathLine item) {
		gmPathLineDAO.updateByPrimaryKeySelective(item);
		
	}
	@Override
	public void delete(String id) {
		// TODO Auto-generated method stub
		gmPathLineDAO.deleteByPrimaryKey(id);
	}
	
	@Override
	public void deleteByWhere(String swhere) {
		// TODO Auto-generated method stub  
		gmPathLineDAO.deleteByWhere(swhere);
	}

	@Override
	public List<GmPathLine> execSql(String sql) {
		// TODO Auto-generated method stub
		return gmPathLineDAO.execSql(sql);
	}

	@Override
	public List<GmPathLine> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		String mainSql = "SELECT * FROM gm_path_line";
		...
		List<GmPathLine> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<GmPathLine> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<GmPathLine> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<GmPathLine> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from GmPathLine  where fuid  not in (select top " + min
				+ " fuid from GmPathLine "+ where + _oB + ") " + where2 + _oB; 
		List<GmPathLine> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  gmPathLineDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( gmPathLineDAO.selectObject(sql).toString());
	     }
	     return 0; 
