...
public class BuDiningServiceImpl implements BuDiningService{
	...
	public BuDiningDAO getBuDiningDAO() {
		return this.buDiningDAO;
	}
	@Override
	public BuDining findById(String id) {
		// TODO Auto-generated method stub
		return buDiningDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(BuDining item) {
		// TODO Auto-generated method stub
		buDiningDAO.insert(item);
	}

	@Override
	public void update(BuDining item) {
		// TODO Auto-generated method stub
		buDiningDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(BuDining item) {
		buDiningDAO.updateByPrimaryKeySelective(item);
		
	}
	@Override
	public void delete(String id) {
		// TODO Auto-generated method stub
		buDiningDAO.deleteByPrimaryKey(id);
	}
	
	@Override
	public void deleteByWhere(String swhere) {
		// TODO Auto-generated method stub  
		buDiningDAO.deleteByWhere(swhere);
	}

	@Override
	public List<BuDining> execSql(String sql) {
		// TODO Auto-generated method stub
		return buDiningDAO.execSql(sql);
	}

	@Override
	public List<BuDining> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		String mainSql = "SELECT * FROM bu_dining";
		...
		List<BuDining> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<BuDining> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<BuDining> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<BuDining> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from BuDining  where fuid  not in (select top " + min
				+ " fuid from BuDining "+ where + _oB + ") " + where2 + _oB; 
		List<BuDining> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  buDiningDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( buDiningDAO.selectObject(sql).toString());
	     }
	     return 0; 
