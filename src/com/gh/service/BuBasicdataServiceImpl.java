...
public class BuBasicdataServiceImpl implements BuBasicdataService{
	private BuBasicdataDAO buBasicdataDAO;
	
	public void setBuBasicdataDAO(BuBasicdataDAO buBasicdataDAO) {
		this.buBasicdataDAO = buBasicdataDAO;
	}
	
	public BuBasicdataDAO getBuBasicdataDAO() {
		return this.buBasicdataDAO;
	}
	@Override
	public BuBasicdata findById(String id) {
		// TODO Auto-generated method stub
		return buBasicdataDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(BuBasicdata item) {
		// TODO Auto-generated method stub
		buBasicdataDAO.insert(item);
	}

	@Override
	public void update(BuBasicdata item) {
		// TODO Auto-generated method stub
		buBasicdataDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(BuBasicdata item) {
		buBasicdataDAO.updateByPrimaryKeySelective(item);
		
	}
	@Override
	public void delete(String id) {
		// TODO Auto-generated method stub
		buBasicdataDAO.deleteByPrimaryKey(id);
	}
	
	@Override
	public void deleteByWhere(String swhere) {
		// TODO Auto-generated method stub  
		buBasicdataDAO.deleteByWhere(swhere);
	}

	@Override
	public List<BuBasicdata> execSql(String sql) {
		// TODO Auto-generated method stub
		return buBasicdataDAO.execSql(sql);
	}

	@Override
	public List<BuBasicdata> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		String mainSql = "SELECT * FROM bu_basicdata";
		...
		List<BuBasicdata> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<BuBasicdata> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<BuBasicdata> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<BuBasicdata> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from BuBasicdata  where fuid  not in (select top " + min
				+ " fuid from BuBasicdata "+ where + _oB + ") " + where2 + _oB; 
		List<BuBasicdata> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  buBasicdataDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( buBasicdataDAO.selectObject(sql).toString());
	     }
	     return 0; 
