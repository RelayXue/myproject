...
public class BuGeographyServiceImpl implements BuGeographyService{
	...
	public BuGeographyDAO getBuGeographyDAO() {
		return this.buGeographyDAO;
	}
	@Override
	public BuGeography findById(String id) {
		// TODO Auto-generated method stub
		return buGeographyDAO.selectByPrimaryKey(id);
	}

	@Override
	public void save(BuGeography item) {
		// TODO Auto-generated method stub
		buGeographyDAO.insert(item);
	}

	@Override
	public void update(BuGeography item) {
		// TODO Auto-generated method stub
		buGeographyDAO.updateByPrimaryKey(item);
	}
	@Override
	public void updateSelective(BuGeography item) {
		buGeographyDAO.updateByPrimaryKeySelective(item);
		
	}
	@Override
	public void delete(String id) {
		// TODO Auto-generated method stub
		buGeographyDAO.deleteByPrimaryKey(id);
	}
	
	@Override
	public void deleteByWhere(String swhere) {
		// TODO Auto-generated method stub  
		buGeographyDAO.deleteByWhere(swhere);
	}

	@Override
	public List<BuGeography> execSql(String sql) {
		// TODO Auto-generated method stub
		return buGeographyDAO.execSql(sql);
	}

	@Override
	public List<BuGeography> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
		String mainSql = "SELECT * FROM bu_geography";
		...
		List<BuGeography> xList = this.execSql(mainSql);
		return xList;
	}
	/*@Override
	public List<BuGeography> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	     ...
	     List<BuGeography> xList = this.execSql(sql);
	     return xList;
	}
	@Override
	public List<BuGeography> selectByPage(int pageIndex, int pageSize,String strWhere, String strOrderBy) {
	 int min = pageIndex == 1 ? 0 : (pageIndex - 1) * pageSize;
		...
		String mainSql = "select top " + pageSize
				+ " * from BuGeography  where fuid  not in (select top " + min
				+ " fuid from BuGeography "+ where + _oB + ") " + where2 + _oB; 
		List<BuGeography> xList = this.execSql(mainSql); 
		return xList;
	}*/
	...
	public int getRecordCount(String strWhere) {
	     ...
	     Object obj =  buGeographyDAO.selectObject(sql);
	     if(obj!=null){
	         return Integer.valueOf( buGeographyDAO.selectObject(sql).toString());
	     }
	     return 0; 
