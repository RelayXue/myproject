...
{ 
        ...
        {
        	Ext.MessageBox.alert("提示","请先从左边设备列表中选择摄像头!");
        	return;
        }
        if(sStartTime != '' && sEndTime != '')
        {
        	WebOcx.QueryRecord(sCameraID,sChannelID,lOption,sStartTime,sEndTime); //lOption: 0 表示前端录像， 1表示中心录像
        }
        else
        {
        	Ext.MessageBox.alert("提示","请填写检索时间段!");
        	return;
        }
