...
<script type="text/javascript">
	...
	function loadData(){
		...
		$.post("phone_traffic_selfDriveTrafficSituation", parms, function(json) {
			var code = json.code;
			var hint = json.hint;
			dialog(hint);
			if (code == 1) {
	...
	function genHTML(item){
		...
		hm += '<li><a href=javascript:clickLike("'+click_like_id+'","'+item.fuid+'","1")><span id="'+click_like_id+'"></span></a><p class="date">发于'+parseDate(item.createdate)+'</p></li>';
		hm += '</ul>';
		$("#main").append(hm);
