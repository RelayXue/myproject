	 ...
	 jQuery(document).ready(function($) {
		 //--------------分页-------------
			$("#page").AutoPage({
					...
					url:'<%=basePath%>accommodation!VotingRecord',
					showNum : 6  // 显示数字
					,show:1
				});
	 });
	...
	<div class="rhandle" style="clean:both">
		...
		<div class="rtable">
			<table width="100%" border="0">
				...
				<s:iterator value="list_BuWeixinVotingRecord" var="list" status="stuts">
					<tr>
						<td>
						...
						<td>
							<span><s:property value="#list.accommodationName" /> </span>
						</td>
					</tr>
				</s:iterator>
			</table>
