...
<script type="text/javascript">
	...
	<body>
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>&nbsp;新增旅店表单</h2>
			...
			<form class="form-horizontal" action="<%=basePath%>accommodation!addHostl"  method="post" enctype="multipart/form-data"  >
				<fieldset>
					...
					-->
							<div class="control-group">
								...
								<table class="controls">
									<tr>
										<td><input type="text" style="width:500px" name="buAccommodation.hname"></td>
									</tr>
									<tr>
										<td><input type="text" style="width:500px" name="buAccommodation.address"></td>
									</tr>
									<tr>
										<td><input type="text" style="width:500px" name="buAccommodation.householder"></td>
									</tr>
									<tr>
										<td><input type="text" style="width:500px" name="buAccommodation.mobile"></td>
									</tr>
								</table>
							</div>
					<!-- 旅店名称 
					...
					*************************************************************************************************************
					-->		
							<div class="control-group">
							  ...
							  <div class="controls">
									<textarea id="content" name="buAccommodation.description" style="width:500px;height:300px"></textarea>
							  </div>
							</div>
					<!-- 简介 
					*************************************************************************************************************
