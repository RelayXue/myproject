				...
				<label class="control-label" for="fileInput" style="color: gray"><strong>图片上传:</strong></label>
					<div class="controls">
						<div id="file_div"></div>
							...
							<!-- --------------乌镇名人------------------- -->
							<% 
							    if(type.equals("004012")){
							%>
							<div class="control-group">
							  <label class="control-label" for="typeahead" style="color: gray"><strong>年份:</strong></label>
							  <div class="controls">
								<input type="text"  name="buNews.remark" value="${buNews.remark}" class="span6 typeahead" id="typeahead"   data-items="2"  style="width:20%"/>
							  </div>
							</div>
							<%
							} 
