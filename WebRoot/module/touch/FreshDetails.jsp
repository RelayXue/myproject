...
<div class="container intro">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
	        	...
	        	<h2 class="section_header fancy" style="background-image:url(img/lined.jpg); background-repeat: repeat-x;background-position: 0 center;"><span style="padding: 0 15px;background-color: rgb(223, 223, 223); ">
	        	<s:property value="buNews.fullname" /></span></h2>
				<div class="owl-carousel owl-theme owl-carousel-init">
					   <div class="img-thumbnail"><img class="img-responsive" src="<%=basePath %>upload/<s:property value="buNews.img1"/>"  /></div>
				</div>
	            <p>
