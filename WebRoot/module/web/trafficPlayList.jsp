    ...
    var total = '${totalPage}';
		...
		function nextPage(){
			...
			$.ajax({
				  type: 'POST',
				  async:false,
				  url: "web/search_trafficPlayList",
				  data: data,
				  dataType: 'html',
...
<div style="width:980px; margin:0 auto;">
    ...
    <div style="background-image:url(<%=basePath%>module/web/images/21_03.png); background-position:0 center; background-repeat:no-repeat; padding-left:36px; height:32px; position:absolute; left:15px; top:12px;" ><span style="font-size:18px; line-height:35px;">交通播报</span></div>
    <div style="padding-left: 50px; overflow:hidden">
          <div id="d_show_004014" class="_menu_btn" onclick="redirectList('search_trafficPlayList?type=004014');">实时路况播报</div>
          <div id="d_show_004015" class="_menu_btn" onclick="redirectList('search_trafficPlayList?type=004015');">交通时刻表</div>
          <div id="d_show_004016" class="_menu_btn" onclick="redirectList('search_trafficPlayList?type=004016');">停车服务</div>
          <div id="d_show_004017" class="_menu_btn" onclick="redirectList('search_trafficPlayList?type=004017');">自驾交通指南</div>
        </div>
  </div>
