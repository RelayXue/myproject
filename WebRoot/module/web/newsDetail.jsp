...
<div style="width:980px; margin:0 auto;padding-top: 15px;">
      
      <!-- 详细列表 -->
      <div class="_news_detail_list">
    <div class="_news_detail_item">
          <div class="_title" align="center" style="height: 40px;font-size: 24px;font-weight: bold;">${news.fullname}</div>
          <!--  
          <div class="_images">
      ...
      -->
          <div class="_content">
          <div align="center">
          <s:if test="news.img1!=null">
          <img src="<%=basePath%>upload/B_<s:property  value="news.img1"/>" />
          </s:if>
          </div>
          <s:property value="news.content" escape="false"/> 
          <div class="_time">发布于<s:date name="news.createdate" format="yyyy-MM-dd hh:mm:ss" /></div>
        <!-- 
