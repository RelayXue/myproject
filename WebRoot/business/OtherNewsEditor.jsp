...
<script type="text/javascript">
	...
	myform.attr("action","<%=basePath%>OtherNews!edit_s?reNum="+reNum+"&imgNum="+imgNum+"&skey=${skey}&indexPage=${indexPage}&type=<%=type%>");
	myform.submit();
}
				...
				<label class="control-label" for="fileInput" style="color: gray"><strong>图片上传:</strong></label>
					<div class="controls">
						<div id="file_div"></div>
							...
							<%if(type!=null&&type.equals("004025")){ %> 
							<div class="control-group">
							  <label class="control-label" for="typeahead" style="color: gray"><strong>360路径:</strong></label>
							  <div class="controls">
								<input type="text"  name="buNews.img2" value="${buNews.img2}" class="span6 typeahead" id="typeahead"   data-items="4" />
							  </div>
							</div>
							<%} %>
							
							<%if(type!=null&&type.equals("004031")){ %> 
							<div class="control-group">
							  <label class="control-label" for="typeahead" style="color: gray"><strong>备注:</strong></label>
							  <div class="controls">
								<input type="text"  name="buNews.remark" value="${buNews.remark}" class="span6 typeahead" id="typeahead"   data-items="4" />
							  </div>
							</div>
							<%} %>
							<!-- --------------------------------- -->
