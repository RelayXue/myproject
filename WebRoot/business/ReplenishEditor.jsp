...
<script type="text/javascript">
	...
	//myform.attr("action","<%=basePath%>OtherNews!edit_s?type=<%=type%>");
	myform.attr("action","<%=basePath%>OtherNews!edit_s?reNum="+reNum+"&imgNum="+imgNum+"&type=<%=type%>");
	myform.submit();
}
...
$(document).ready(function() {
	...
	<body>
			...
			<form id="myform" class="form-horizontal" action=""  method="post" enctype="multipart/form-data"  >
				<fieldset>
				<legend></legend>
				<%if(type!=null&&type.equals("004035")){ %> 
				...
				<!-- --------------------------------- -->
							<div class="control-group">
							  <label class="control-label" for="textarea2" style="color: gray"><strong>信息编辑: </strong></label>
							  <div class="controls">
							  		<input type="hidden"  name="buNews.fullname" value="${buNews.fullname}" class="span6 typeahead" id="typeahead"   data-items="4" />
