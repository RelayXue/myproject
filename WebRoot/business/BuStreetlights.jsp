...
<head>
	 ...
	 function serach(){
		 var skey=$("#mc").val();
		 var url="buStreetlights?skey="+skey;
		 window.location.href=url;
	 }
	 function add(){
	 var url="<%=basePath %>business/BuStreetlightsEditor.jsp";
	 window.location.href=url;
	 }
	 function delMore() {
	...
	<div class="rightnav">
		...
		<div class="rtable">
			<table width="100%" border="0">
				...
				<s:iterator value="buStreetlights_list" var="list" status="stuts">
					<tr>
						<td>
						...
						<td>
							<span><s:property value="#stuts.index+1" /> </span>
								...
								<td><s:property value="#list.dnumber" />&nbsp; </td>
						...
						<td>
							...
							<a href="<%=basePath%>buStreetlights!update_show?id=<s:property value="#list.fuid"  />&skey=${skey}&indexPage=${indexPage}">编辑</a>&nbsp;&nbsp;
							</s:if>
							<s:if test="com.hisDelete==true">
							<a onclick="if(!confirm('确定删除！')){return false;}" href="<%=basePath%>buStreetlights!delete?id=<s:property value="#list.fuid"  />&skey=${skey}&indexPage=${indexPage}">删除</a>
							</s:if>
						</td>
					</tr>
				</s:iterator>
		...
		<div style="display: none;">
			<form id="mform" action="buStreetlights!delete" method="post">
