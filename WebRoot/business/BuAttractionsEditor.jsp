...
function edit(){
	...
	myform.attr("action","<%=basePath%>buAttractions!edit?reNum="+reNum+"&imgNum="+imgNum+"&skey=${skey}&indexPage=${indexPage}&type=<%=type%>");
	myform.submit();
}
...
<body>
	<form id="myform" action="" method="post" ENCTYPE="multipart/form-data">
		<div class="inright">
			...
			<div class="rightnav">
			 <a href="" class="active">景点管理</a><!--  <%=((Map)application.getAttribute("DatadictionaryMap")).get(type) %>-->
					...
					<div class="sdtable">
						<table width="100%" border="0">
							<tr>
								...
								<td>
									 <input type="text"  class="inp2" id="fullname"  name="buAttractions.fullname"  value="${buAttractions.fullname}" style="float: left;"/>
									 <input type="hidden"  id="fuid"    name="buAttractions.fuid"  value='${buAttractions.fuid}' />
								</td>
							</tr>
							...
							<tr>
								...
								<td>
								   <input type="text"  class="inp2"    name="buAttractions.address"  value='${buAttractions.address}' />
								</td>
							</tr>	
							...
							<tr>
								...
								<td>
								<textarea   style='border: 1px solid #bfbfbf' rows="5" cols="80" name="buAttractions.introduction">${buAttractions.introduction}</textarea>
								</td>
							</tr>	
							...
							<!--<tr>
								...
								<input id="btnPoint" type="button" class="input-page-btn"   value="开启描绘"   />
									<input type="hidden"  id="fx" class="input-text"    name="buAttractions.fx"  value='${buAttractions.fx}' />
									 <input type="hidden"  class="input-text"  id="fy"  name="buAttractions.fy"  value='${buAttractions.fy}' />
								</td>
							</tr>	
