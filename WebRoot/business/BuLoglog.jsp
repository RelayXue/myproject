...
<head>
	 ...
	 function serach(){
		 var skey=$("#mc").val();
		 var url="buLoglog?skey="+skey;
		 window.location.href=url;
	 }
	 function add(){
	 var url="<%=basePath %>business/BuLoglogEditor.jsp";
	 window.location.href=url;
	 }
	 function delMore() {
	...
	<div class="rightnav">
		...
		<div class="rtable">
			<table width="100%" border="0">
				...
				<s:iterator value="buLoglog_list" var="list" status="stuts">
					<tr>
						<td>
						...
						<td>
							<span><s:property value="#stuts.index+1" /> </span>
								...
								<td><s:date name="#list.logingtime" format="yyyy-MM-dd HH:mm:ss" /></td>
								<td><s:date name="#list.outtime" format="yyyy-MM-dd HH:mm:ss" /></td>
		...
		<div style="display: none;">
			<form id="mform" action="buLoglog!delete" method="post">
