...
<head>
	 ...
	 function serach(){
		 var skey=$("#mc").val();
		 var url="buServiceltems?skey="+skey;
		 window.location.href=url;
	 }
	 function add(){
	 var url="<%=basePath %>business/BuServiceltemsEditor.jsp";
	 window.location.href=url;
	 }
	 function delMore() {
	...
	<div class="rightnav">
		...
		<div class="rtable">
			<table width="100%" border="0">
				...
				<s:iterator value="buServiceltems_list" var="list" status="stuts">
					<tr>
						<td>
						...
						<td>
							...
							<a href="<%=basePath%>buServiceltems!update_show?id=<s:property value="#list.fuid"  />&skey=${skey}&indexPage=${indexPage}">编辑</a>&nbsp;&nbsp;
							</s:if>
							<s:if test="com.hisDelete==true">
							<a onclick="if(!confirm('确定删除！')){return false;}" href="<%=basePath%>buServiceltems!delete?id=<s:property value="#list.fuid"  />&skey=${skey}&indexPage=${indexPage}">删除</a>
							</s:if>
						</td>
					</tr>
				</s:iterator>
		...
		<div style="display: none;">
			<form id="mform" action="buServiceltems!delete" method="post">
