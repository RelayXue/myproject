	...
	<head>
	 ...
	 jQuery(document).ready(function($) {
	 	 $("#page").AutoPage({
					...
					url:'Datadictionary!showChild3?code=${code}&skey=${skey}',
					showNum : 6  // 显示数字
					,show:1
				});
	 });
	 function serach(){
	 var skey=$("#mc").val();
	 var url="Datadictionary!showChild3?skey="+skey+"&code="+code;
	 ...
	 window.location.href="Datadictionary!showChild2?code="+code;
	 }
	</script>
		<style>
